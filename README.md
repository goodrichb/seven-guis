...
The rest of this README is from the re-frame template used to bootstrap a dev environment. re-frame itself is not used in the GUIs.
...
* [`src/cljs/seven_guis/`](src/cljs/seven_guis/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/seven_guis/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `seven-guis` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/seven_guis/config.cljs) defaults to `true` in
...
(ns seven-guis.example
  (:require [seven-guis.config :as config])
